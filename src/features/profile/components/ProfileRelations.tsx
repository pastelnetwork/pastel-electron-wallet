...
const cx_tab =
  'text-sm border-b font-medium pt-1 pb-3 text-gray-b0 border-gray-f3 cursor-pointer flex-grow'
const cx_tab_active =
  'text-sm border-b font-bold pt-1 pb-3 text-gray-33 border-gray-33 cursor-pointer flex-grow'
