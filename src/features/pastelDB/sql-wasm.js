  ...
  initSqlJsPromise = new Promise(function (resolveModule, reject) {
    ...
    e.onRuntimeInitialized = function () {
      ...
      var d = y(4),
        ...
        Mc = f('sqlite3_result_text', '', [
          'number',
          'string',
          'number',
          'number',
        ]),
        Nc = f('sqlite3_result_blob', '', [
          'number',
          'number',
          'number',
          'number',
      ...
      a.prototype.get = function (h) {
        ...
        h = []
        for (var l = vc(this.Ra), p = 0; p < l; p += 1)
          switch (Ac(this.Ra, p)) {
            case 1:
            case 2:
              h.push(this.Ib(p))
      ...
      a.prototype.getColumnNames = function () {
        for (var h = [], l = uc(this.Ra), p = 0; p < l; p += 1)
          h.push(Bc(this.Ra, p))
        return h
      }
        ...
        try {
          ...
          for (h = []; 0 !== x(D, 'i8'); ) {
            ...
            if (0 !== ja) {
              B = null
              q = new a(ja, this)
              for (null != l && q.bind(l); q.step(); )
                null === B &&
                  ((B = { columns: q.getColumnNames(), values: [] }),
                  h.push(B)),
                  B.values.push(q.get())
              q.free()
            }
      ...
      c.prototype.close = function () {
        null !== this.db &&
          (Object.values(this.fb).forEach(function (h) {
            h.free()
          }),
          Object.values(this.Xa).forEach(ra),
          (this.Xa = {}),
        ...
        var p = va(function (q, B, ha) {
          for (var D, ia = [], ja = 0; ja < B; ja += 1) {
            ...
            if (1 === R || 2 === R) E = Kc(E)
              ...
              E = Hc(R)
              R = Jc(R)
              for (var wb = new Uint8Array(E), Ea = 0; Ea < E; Ea += 1)
                wb[Ea] = z[R + Ea]
              E = wb
            } else E = null
            ia.push(E)
    ...
    var I = '',
      ...
      Fa
    if (za)
      (I = G ? require('path').dirname(I) + '/' : __dirname + '/'),
        (Ba = function (a, b) {
          Da || (Da = require('fs'))
          Fa || (Fa = require('path'))
          a = Fa.normalize(a)
      ...
      G
        ...
        : document.currentScript && (I = document.currentScript.src),
        (I =
          0 !== I.indexOf('blob:') ? I.substr(0, I.lastIndexOf('/') + 1) : ''),
        (Ba = function (a) {
    ...
    function va(a) {
      ...
      if (Ia.has(a)) a = Ia.get(a)
      else {
        if (Ha.length) c = Ha.pop()
        else {
          c = b.length
          try {
            b.grow(1)
        ...
        try {
          ...
          if ('function' === typeof WebAssembly.Function) {
            ...
            d = new WebAssembly.Instance(d, { e: { f: a } }).exports.f
          }
          b.set(c, d)
        }
        Ia.set(a, c)
    ...
    e.wasmMemory
      ? (Oa = e.wasmMemory)
      : (Oa = new WebAssembly.Memory({ initial: Za / 65536, maximum: 32768 }))
    Oa && (Xa = Oa.buffer)
    Za = Xa.byteLength
    Ya(Xa)
    var $a = [],
    ...
    function mb() {
      return Ka || (!ya && !G) || 'function' !== typeof fetch || hb('file://')
        ? Promise.resolve().then(lb)
        : fetch(ib, { credentials: 'same-origin' })
            .then(function (a) {
          ...
          if (!a.input.length) {
            ...
            if (za) {
              var c = Buffer.zb ? Buffer.zb(256) : new Buffer(256),
                d = 0
              try {
                d = Da.readSync(process.stdin.fd, c, 0, 256, null)
              } catch (f) {
      ...
      P = {
        ...
        createNode: function (a, b, c, d) {
          ...
          P.Va ||
            (P.Va = {
              ...
              link: {
                node: { Ua: P.Na.Ua, Ta: P.Na.Ta, readlink: P.Na.readlink },
                stream: {},
              },
              ub: { node: { Ua: P.Na.Ua, Ta: P.Na.Ta }, stream: Lb },
            })
          c = Mb(a, b, c, d)
          Q(c.mode)
            ? ((c.Na = P.Va.dir.node), (c.Oa = P.Va.dir.stream), (c.Ma = {}))
            : 32768 === (c.mode & 61440)
            ? ((c.Na = P.Va.file.node),
              (c.Oa = P.Va.file.stream),
              (c.Sa = 0),
              (c.Ma = null))
            : 40960 === (c.mode & 61440)
            ? ((c.Na = P.Va.link.node), (c.Oa = P.Va.link.stream))
            : 8192 === (c.mode & 61440) &&
              ((c.Na = P.Va.ub.node), (c.Oa = P.Va.ub.stream))
        ...
        vb: function (a, b) {
          ...
          c >= b ||
            ...
            0 < a.Sa && a.Ma.set(c.subarray(0, a.Sa), 0))
        },
        Pb: function (a, b) {
          if (a.Sa != b)
            if (0 == b) (a.Ma = null), (a.Sa = 0)
            else {
              if (!a.Ma || a.Ma.subarray) {
                var c = a.Ma
                a.Ma = new Uint8Array(b)
                c && a.Ma.set(c.subarray(0, Math.min(b, a.Sa)))
              } else if ((a.Ma || (a.Ma = []), a.Ma.length > b)) a.Ma.length = b
              else for (; a.Ma.length < b; ) a.Ma.push(0)
              a.Sa = b
            }
        },
        Na: {
        ...
        Oa: {
          ...
          write: function (a, b, c, d, f, g) {
            ...
            P.vb(a, f + d)
            if (a.Ma.subarray && b.subarray) a.Ma.set(b.subarray(c, c + d), f)
            else for (g = 0; g < d; g++) a.Ma[f + g] = b[c + g]
          ...
          Za: function (a, b, c) {
            1 === c
              ? (b += a.position)
              : 2 === c && 32768 === (a.node.mode & 61440) && (b += a.node.Sa)
    ...
    function u(a, b, c, d) {
      ...
      !e.logReadFiles ||
        ...
        (Pc || (Pc = {}),
        a in Pc ||
          ((Pc[a] = 1), J('FS.trackingDelegate error on read file: ' + a)))
      try {
        U.onOpenFile &&
          ((g = 0),
          1 !== (b & 2097155) && (g |= 1),
    ...
    var id = {
        ...
        try {
          a: {
            ...
            if (0 !== (d & 16) && 0 !== a % 16384) var t = -28
              ...
              Xc[w] = { Lb: w, Kb: b, kb: n, fd: f, Nb: c, flags: d, offset: g }
              t = w
            }
          }
          return t
      ...
      r: function (a, b) {
        ...
        try {
          b = c
          var d = V(a, { Ya: !0 }).node
          d.Na.Ta(d, { timestamp: Math.max(b, c) })
          return 0
        } catch (f) {
          a = f
          if (!(a instanceof O)) {
    ...
    ;(function () {
      ...
      if (e.instantiateWasm)
        try {
          ...
          return (
            J('Module.instantiateWasm callback failed with error: ' + f), !1
          )
        }
      ;(function () {
        if (
          ...
          return c(b)
        fetch(ib, { credentials: 'same-origin' }).then(function (f) {
      ...
      function a() {
        if (!jd && ((jd = !0), (e.calledRun = !0), !Pa)) {
          e.noFSInit ||
            ...
            (e.stdout = e.stdout),
            (e.stderr = e.stderr),
            e.stdin ? Vc('stdin', e.stdin) : ic('/dev/tty', '/dev/stdin'),
            e.stdout
              ? Vc('stdout', null, e.stdout)
              : ic('/dev/tty', '/dev/stdout'),
            e.stderr
              ? Vc('stderr', null, e.stderr)
              : ic('/dev/tty1', '/dev/stderr'),
            u('/dev/stdin', 'r'),
            u('/dev/stdout', 'w'),
            u('/dev/stderr', 'w'))
          nb(ab)
