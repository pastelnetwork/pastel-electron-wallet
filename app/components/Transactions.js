...
const TxModalInternal = ({ modalIsOpen, tx, info, closeModal, currencyName, pslPrice, setSendTo, history }) => {
  let txid = '';
  let type = '';
  let typeIcon = '';
  let typeColor = '';
...
const TxItemBlock = ({ transaction, currencyName, pslPrice, txClicked, addressBookMap }) => {
